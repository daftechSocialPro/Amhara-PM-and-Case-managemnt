...
namespace PM_Case_Managemnt_API.Controllers.Case
{
    ...
    public class CaseEncodingController : ControllerBase
    {
        ...
        public async Task<IActionResult> CompletedCases(Guid subOrgId, Guid orgStuctId)
        {
            try
            {
                return Ok(await _caseEncodeService.CompletedCases(subOrgId, orgStuctId));
        ...
        public async Task<IActionResult> GetArchivedCases(Guid subOrgId, Guid orgStuctId)
        {
            try
            {
                return Ok(await _caseEncodeService.GetArchivedCases(subOrgId, orgStuctId));
