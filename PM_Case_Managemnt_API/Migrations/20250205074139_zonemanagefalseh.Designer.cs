...
namespace PMCaseManagemntAPI.Migrations.DB
{
    ...
    [Migration("20250205074139_zonemanagefalseh")]
    partial class zonemanagefalseh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.CaseModel.Case", b =>
                {
                    ...
                    b.Property<Guid?>("CompletedOrgStructureId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.CaseModel.CaseHistory", b =>
                {
                    ...
                    b.Property<Guid?>("ChildCaseTypeId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.Organization.Kebele", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.Organization.Woreda", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.Organization.Zone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.SmsTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.KPI.KPIData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.KPI.KPIList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.CaseModel.CaseHistory", b =>
                {
                    ...
                    b.HasOne("PM_Case_Managemnt_API.Models.CaseModel.CaseType", "ChildCaseType")
                        .WithMany()
                        .HasForeignKey("ChildCaseTypeId");
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.Organization.Kebele", b =>
                {
                    b.HasOne("PM_Case_Managemnt_API.Models.Common.Organization.Woreda", "Woreda")
                        .WithMany()
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.Common.Organization.Woreda", b =>
                {
                    b.HasOne("PM_Case_Managemnt_API.Models.Common.Organization.Zone", "Zone")
                        .WithMany()
            ...
            modelBuilder.Entity("PM_Case_Managemnt_API.Models.KPI.KPIDetails", b =>
                {
                    b.HasOne("PM_Case_Managemnt_API.Models.KPI.KPIList", "KPI")
                        .WithMany("KPIDetails")
                        .HasForeignKey("KPIId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
