...
export class OrganizationService {
  ...
  getDashboardLineChart(subOrgId:string,year:number){

    return this.http.get<barChartDto>(this.BaseURI+"/Dashboard/GetMonthlyReportBarChart?subOrgId=" + subOrgId+ "&year="+year)
  }
