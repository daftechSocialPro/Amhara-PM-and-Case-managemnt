...
@Component({
  selector: 'app-pm-zone-dashboard',
  templateUrl: './pm-zone-dashboard.component.html',
  styleUrls: ['./pm-zone-dashboard.component.css']
})
export class PmZoneDashboardComponent {
