...
export class CaseService {
    ...
    getCompletedCases(subOrgId: string, orgStuctId: string) {
        return this.http.get<ICaseView[]>(this.BaseURI + "/completedList?subOrgId=" + subOrgId + "&orgStuctId=" + orgStuctId)
    }
    ...
    getArchiveCases(subOrgId: string, orgStuctId: string) {

        return this.http.get<ICaseView[]>(this.BaseURI + "/getArchivedCases?subOrgId=" + subOrgId + "&orgStuctId=" + orgStuctId)
    }
