...
const routes: Routes = [
  ...
  { path: 'issuedcase' ,canActivate:[AuthGuard],component : IssuedCaseComponent ,data:{permittedRoles : ['Super Admin','Case Admin','Encoder','Director',,'Secretery']}},
  ...
  { path: 'kpiManagment', canActivate:[AuthGuard],component:KpiManagmentComponent,data:{permittedRoles: ['Super Admin','Director','PM Admin','Planner','Plan Reporting']}},
  ...
  { path: 'completedCases', canActivate:[AuthGuard],component: CompletedCasesComponent,data:{permittedRoles : ['Super Admin','Case Admin','Director','Secretery','Member']}},
  { path: 'archivecase', canActivate:[AuthGuard],component: ArchivecaseComponent, data : {permittedRoles:['Super Admin','Case Admin','Director','Secretery','Member']}},
